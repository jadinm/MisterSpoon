...
public class RestaurantForClient extends Activity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		prebook.setOnClickListener(new View.OnClickListener() {//launch another view
			@Override
			public void onClick(View v) {
				Toast toast = Toast.makeText(context, "Un client veut lancer l'activité preBooking", Toast.LENGTH_SHORT);
				toast.show();
				//TODO
			}
		});
		...
		book.setOnClickListener(new View.OnClickListener() {//launch another view
			@Override
			public void onClick(View v) {
				Toast toast = Toast.makeText(context, "Un client veut lancer l'activité Booking", Toast.LENGTH_SHORT);
				toast.show();
				//TODO
			}
		});
