...
public class RestaurantList {
	...
	public RestaurantList (MySQLiteHelper sqliteHelper, String town, Client client, Boolean getFromDatabase) {
		...
		Cursor cursor = db.rawQuery(" SELECT " + MySQLiteHelper.Restaurant_column[2] + " FROM " + MySQLiteHelper.TABLE_Restaurant + " WHERE " + MySQLiteHelper.Restaurant_column[5] + " = " + " SELECT " + MySQLiteHelper.Address_column[1] + " FROM " + MySQLiteHelper.Address_column[1] + " WHERE " + MySQLiteHelper.Address_column[4] + " = " + "'"+town+"'" , null);
