...
public class CarteBuilder {
	...
	public boolean setMenuCategorie(Menu menuToChange, String categorie) {
		...
		MySQLiteHelper.Additional_Orders.add("UPDATE " + MySQLiteHelper.TABLE_MenuPrice + " SET " + MySQLiteHelper.MenuPrice_column[3] + " = '" + categorie + "' WHERE " + MySQLiteHelper.MenuPrice_column[2] + "='" + menuToChange.getMenuName() + "' AND " + MySQLiteHelper.MenuPrice_column[1] + "='" + menuToChange.getRestName() + "' AND " + MySQLiteHelper.MenuPrice_column[3] + "='" + categorie + "';");
		db.execSQL("UPDATE " + MySQLiteHelper.TABLE_MenuPrice + " SET " + MySQLiteHelper.MenuPrice_column[3] + " = '" + categorie + "' WHERE " + MySQLiteHelper.MenuPrice_column[2] + "='" + menuToChange.getMenuName() + "' AND " + MySQLiteHelper.MenuPrice_column[1] + "='" + menuToChange.getRestName() + "' AND " + MySQLiteHelper.MenuPrice_column[3] + "='" + categorie + "';");
		MySQLiteHelper.Additional_Orders.add("UPDATE " + MySQLiteHelper.TABLE_Menu + " SET " + MySQLiteHelper.Menu_column[2] + " = '" + categorie + "' WHERE " + MySQLiteHelper.Menu_column[1] + "='" + menuToChange.getMenuName() + "' AND " + MySQLiteHelper.Menu_column[3] + "='" + menuToChange.getRestName() + "' AND " + MySQLiteHelper.Menu_column[2] + "='" + categorie + "';");
		db.execSQL("UPDATE " + MySQLiteHelper.TABLE_Menu + " SET " + MySQLiteHelper.Menu_column[2] + " = '" + categorie + "' WHERE " + MySQLiteHelper.Menu_column[1] + "='" + menuToChange.getMenuName() + "' AND " + MySQLiteHelper.Menu_column[3] + "='" + menuToChange.getRestName() + "' AND " + MySQLiteHelper.Menu_column[2] + "='" + categorie + "';");
