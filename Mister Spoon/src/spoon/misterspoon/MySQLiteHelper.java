...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void populateDatabase(SQLiteDatabase db) {//To correct (menuPrice) -> I don't find a good example
		...
		db.execSQL("INSERT INTO " + TABLE_MenuPrice + "(" + MenuPrice_column[1] + ", " + MenuPrice_column[2] + ", " + MenuPrice_column[3] +  ", " + MenuPrice_column[4] +") VALUES('Crêperie Bretonne','Dejeuner','plat',7);  ");
