...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void populateDatabase(SQLiteDatabase db) {//To correct (menuPrice) -> I don't find a good example
		...
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Lunch','plat','Comme chez soi','Coquelet croustillant a l''instar de Visa, garniture exotique a la verveine-citron'); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Coquelet croustillant � l'instar de Vis�, garniture exotique � la verveine-citron','Comme chez soi',25.5,5, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Contrefilet de Rubia Gallega � la Leffe brune, gel�e de moelle, g�teau de patates douces au romarin','Comme chez soi',69,5, NULL); ");
