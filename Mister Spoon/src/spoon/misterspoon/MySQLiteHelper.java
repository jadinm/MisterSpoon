...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void populateDatabase(SQLiteDatabase db) {//To correct (menuPrice) -> I don't find a good example
		...
		db.execSQL("INSERT INTO " + TABLE_Restaurant + "(" + Restaurant_column[1] + ", " + Restaurant_column[2] + ", " + Restaurant_column[3] + ", " + Restaurant_column[4] + ", " + Restaurant_column[5]+ ", " + Restaurant_column[6] + ", " + Restaurant_column[7] + ", " + Restaurant_column[8] +")  VALUES('Loungeatude', 'mathieu.jadin@student.uclouvain.be','010/45.64.62','50.6609,4.617962',55,'Un simple coup deeil suffit e se rendre compte que vous nՐtes ni dans un restaurant. Ni dans un bar. Encore moins dans une galerie deart. Et pourtant, vous prendrez leaperitif au salon, vous dinerez dans la salle e manger et vous terminerez peut-etre votre pousse-cafe au BABeL devant une huile ou une aquarelle." +"\n" + " Vous etes au Loungeatude." +"\n" + " Vous etes chez vous.', 3, 2); ");
