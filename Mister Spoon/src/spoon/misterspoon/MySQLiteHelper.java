...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void populateDatabase(SQLiteDatabase db) {//To correct (menuPrice) -> I don't find a good example
		...
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Salade au roquefort','Creperie Bretonne',13.95,3, 'Ze salade au roquefort pour les vrais bonhommes'); ");//12.8125
		...
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Filet pur de boeuf irlandais en Tagliata, parmigiano et rucola','Loungeatude',25.95,10, NULL);  ");
		...
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Entrecote de Boeuf Belge Grillee +- 300gr','Le Petit Vingtieme',19,5, NULL); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Order + "(" + Order_column[1] + ", " + Order_column[2] + ", " + Order_column[3] + ", " + Order_column[4] + ", " + Order_column[5] +")  VALUES('Creperie Bretonne','toni@hotmail.com','NULL','Crepe normande',2); ");
