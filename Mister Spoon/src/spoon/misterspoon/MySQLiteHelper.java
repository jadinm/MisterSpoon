...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void createDatabase(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE " + TABLE_Client + "(" + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + Client_column[1] + " VARCHAR NOT NULL  UNIQUE, " + Client_column[2] + "  VARCHAR NOT NULL, " + Client_column[3] + "  VARCHAR);");
		...
		db.execSQL("CREATE TABLE " + TABLE_Order + "(" + _ID + " INTEGER PRIMARY KEY AUTOINCREMENT , " + Order_column[1] +" VARCHAR NOT NULL, " + Order_column[2] +" VARCHAR NOT NULL, " + Order_column[3] + " VARCHAR, " + Order_column[4] + " VARCHAR, " + Order_column[5] + " INTEGER NOT NULL, FOREIGN KEY ("+Order_column[1]+") REFERENCES "+ TABLE_Restaurant + "(" + Restaurant_column[1] +"), FOREIGN KEY ("+Order_column[2]+") REFERENCES "+ TABLE_Client +"("+Client_column[1]+") ON UPDATE CASCADE ON DELETE CASCADE);");
	...
	public void populateDatabase(SQLiteDatabase db) {//To correct (menuPrice) -> I don't find a good example
		...
		db.execSQL("INSERT INTO " + TABLE_Restaurant + "(" + Restaurant_column[1] + ", " + Restaurant_column[2] + ", " + Restaurant_column[3] + ", " + Restaurant_column[4] + ", " + Restaurant_column[5]+ ", " + Restaurant_column[6] + ", " + Restaurant_column[7] + ", " + Restaurant_column[8] +")  VALUES('Loungeatude', 'mathieu.jadin@student.uclouvain.be','010/45.64.62','50.6609,4.617962',55,'Un simple coup d��il suffit � se rendre compte que vous nՐtes ni dans un restaurant. Ni dans un bar. Encore moins dans une galerie d�art. Et pourtant, vous prendrez l�ap�ritif au salon, vous dinerez dans la salle � manger et vous terminerez peut-�tre votre pousse-caf� au BAB�L devant une huile ou une aquarelle." +"\n" + " Vous �tes au Loungeatude." +"\n" + " Vous �tes chez vous.', 3, 2); ");
		db.execSQL("INSERT INTO " + TABLE_Restaurant + "(" + Restaurant_column[1] + ", " + Restaurant_column[2] + ", " + Restaurant_column[3] + ", " + Restaurant_column[4] + ", " + Restaurant_column[5]+ ", " + Restaurant_column[6] + ", " + Restaurant_column[7] + ", " + Restaurant_column[8] +")   VALUES('Cr�perie Bretonne','ludovic.fastre@student.uclouvain.be','010/45.15.85','50.668572,4.616146',45,'Dans notre salle au d�cor rustique ou en terrasse aux beaux jours, d�gustez l''une de nos 350 cr�pes sal�es d''inspiration fran�aise ou exotique, ou appr�ciez l''une de nos salades vari�es. Pour accompagner votre plat, nous avons � votre disposition une carte de plus de 200 bi�res artisanales belges dont toutes les trapistes et 5 bi�res au f�t. Nous pouvons aussi vous servir un cidre bien frais ou vous laisser choisir un vin de pays." +"\n" + "En dessert, vous choisirez une cr�pe sucr�e ou flamb�e, une coupe de glace maison ou encore un milkshake que vous accompagnerez d''un caf� lointain, un th� vert parfum� ou une infusion. Nous vous accueillons et vous servons tout au long du jour de 9h du matin jusqu''� 1h de la nuit, la cuisine restant ouverte non-stop.', 3, 1); ");
		db.execSQL("INSERT INTO " + TABLE_Restaurant + "(" + Restaurant_column[1] + ", " + Restaurant_column[2] + ", " + Restaurant_column[3] + ", " + Restaurant_column[4] + ", " + Restaurant_column[5]+ ", " + Restaurant_column[6] + ", " + Restaurant_column[7] + ", " + Restaurant_column[8] +")  VALUES('Le Petit Vingti�me','antoine.walsdorff@student.uclouvain.be','010/48.84.26','50.671578,4.61282',45,'Au sein du Mus�e Herg�, le restaurant" +"\n" + "le Petit Vingti�me vous invite, dans un cadre raffin�" +"\n" + "et moderne, pour un moment de plaisir et de d�tente." +"\n" + "Proposant une gastronomie fine variant au fil" +"\n" + "des saisons, vous pourrez y d�guster au gr� de" +"\n" + "vos envies des pr�parations m�lant fra�cheur" +"\n" + "des produits et puret� du go�t.', 4, 1); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Loungeatude','V�g�tarien'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Loungeatude','Wi-Fi'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Loungeatude','Acc�s handicap�s'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +") VALUES('Loungeatude','Service traiteur');  ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Cr�perie Bretonne','V�g�tarien'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Cr�perie Bretonne','Terrasse'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +") VALUES('Cr�perie Bretonne','Service traiteur');  ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +") VALUES('Le Petit Vingti�me','Service traiteur');  ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +") VALUES('Le Petit Vingti�me','Wi-Fi');  ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Le Petit Vingti�me','Acc�s handicap�s'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Le Petit Vingti�me','Climatisation'); ");
		db.execSQL("INSERT INTO " + TABLE_Advantage + "(" + Advantage_column[1] + ", " + Advantage_column[2] +")  VALUES('Le Petit Vingti�me','Plats enfants'); ");
		
		db.execSQL("INSERT INTO " + TABLE_Cook + "(" + Cook_column[1] + ", " + Cook_column[2] +")  VALUES('Le Petit Vingti�me','Fran�aise'); ");
		db.execSQL("INSERT INTO " + TABLE_Cook + "(" + Cook_column[1] + ", " + Cook_column[2] +")  VALUES('Loungeatude','Fran�aise'); ");
		db.execSQL("INSERT INTO " + TABLE_Cook + "(" + Cook_column[1] + ", " + Cook_column[2] +")  VALUES('Cr�perie Bretonne','Cr�pes'); ");
		db.execSQL("INSERT INTO " + TABLE_Cook + "(" + Cook_column[1] + ", " + Cook_column[2] +")  VALUES('Loungeatude','Fusion'); ");
		db.execSQL("INSERT INTO " + TABLE_Cook + "(" + Cook_column[1] + ", " + Cook_column[2] +")  VALUES('Loungeatude','M�diterran�enne'); ");
		
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Mardi','10:30:00','17:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Mercredi','10:30:00','17:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Jeudi','10:30:00','17:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Vendredi','10:30:00','17:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Samedi','10:00:00','18:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Schedule + "(" + Schedule_column[1] + ", " + Schedule_column[2] +", " + Schedule_column[3] + ", " + Schedule_column[4] +")  VALUES('Le Petit Vingti�me','Dimanche','10:00:00','18:00:00'); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Closing + "(" + Closing_column[1] + ", " + Closing_column[2] +")  VALUES('Cr�perie Bretonne','2013-05-01'); ");
		
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Nos Viandes','plat','Le Petit Vingti�me','Entrecote de Boeuf Belge Grillee +- 300gr'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Nos Entr�es','entree','Le Petit Vingti�me','Carpaccio de Bresaola et Jambon de Parme'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Nos Poissons','plat','Le Petit Vingti�me','Gambas r�ties au four'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Potage-P�te-Salade-Pr�paration','entree','Loungeatude','Potage de scampis et canard laqu� � la tha�e'); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Salades','entree','Cr�perie Bretonne','Salade au roquefort'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Salades','entree','Cr�perie Bretonne','Salade Tomates Mozzarella'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Cr�pe des Gourmets','plat','Cr�perie Bretonne','Cr�pe La tartiflette'); ");
		db.execSQL("INSERT INTO " + TABLE_Menu + "(" + Menu_column[1] + ", " + Menu_column[2] +", " + Menu_column[3] +", " + Menu_column[4] +")  VALUES('Cr�pe des Gourmets','plat','Cr�perie Bretonne','Cr�pe au saumon fum�, sauce cr�me et citron � l''aneth'); ");
		//To correct -> find menu with price but with some meals recorded
		db.execSQL("INSERT INTO " + TABLE_MenuPrice + "(" + MenuPrice_column[1] + ", " + MenuPrice_column[2] + ", " + MenuPrice_column[3] +  ", " + MenuPrice_column[4] +") VALUES('Cr�perie Bretonne','Dejeuner','plat',7);  ");
		
		db.execSQL("INSERT INTO " + TABLE_Payment + "(" + Payment_column[1] + ", " + Payment_column[2] +")  VALUES('Cr�perie Bretonne','Cash'); ");
		db.execSQL("INSERT INTO " + TABLE_Payment + "(" + Payment_column[1] + ", " + Payment_column[2] +")  VALUES('Le Petit Vingti�me','MasterCard'); ");
		db.execSQL("INSERT INTO " + TABLE_Payment + "(" + Payment_column[1] + ", " + Payment_column[2] +")  VALUES('Le Petit Vingti�me','Cash'); ");
		db.execSQL("INSERT INTO " + TABLE_Payment + "(" + Payment_column[1] + ", " + Payment_column[2] +")  VALUES('Loungeatude','Cash'); ");
		
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Salade au roquefort','Cr�perie Bretonne',13.95,3, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Salade Tomates Mozzarella','Cr�perie Bretonne',11.2,20, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Cr�pe La tartiflette','Cr�perie Bretonne',12.15,16, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Cr�pe au saumon fum�, sauce cr�me et citron � l''aneth','Cr�perie Bretonne',13.95,15, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Potage de scampis et canard laqu� � la tha�e','Loungeatude',17.95,10, NULL);  ");
		...
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Carpaccio de Bresaola et Jambon de Parme','Le Petit Vingti�me',12,10, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Entrec�te de Boeuf Belge Grill�e +- 300gr','Le Petit Vingti�me',19,5, NULL); ");
		db.execSQL("INSERT INTO " + TABLE_Meal + "(" + Meal_column[1] + ", " + Meal_column[2] + ", " + Meal_column[3] + ", " + Meal_column[4] + ", " + Meal_column[5] +")  VALUES('Gambas r�ties au four','Le Petit Vingti�me',17,20, NULL); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Booking + "(" + Booking_column[1] + ", " + Booking_column[2] + ", " + Booking_column[3] + ", " + Booking_column[4] +") VALUES('Le Petit Vingti�me','toni@hotmail.com',3,'2013-04-30 19:00:00');  ");
		db.execSQL("INSERT INTO " + TABLE_Booking + "(" + Booking_column[1] + ", " + Booking_column[2] + ", " + Booking_column[3] + ", " + Booking_column[4] +")  VALUES('Cr�perie Bretonne','j.p@yahoo.fr',45,'2013-05-02 20:00:00'); ");
		db.execSQL("INSERT INTO " + TABLE_Booking + "(" + Booking_column[1] + ", " + Booking_column[2] + ", " + Booking_column[3] + ", " + Booking_column[4] +")  VALUES('Cr�perie Bretonne','toni@hotmail.com',6,'2013-04-30 22:00:00'); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Order + "(" + Order_column[1] + ", " + Order_column[2] + ", " + Order_column[3] + ", " + Order_column[4] + ", " + Order_column[5] +")  VALUES('Le Petit Vingti�me','toni@hotmail.com','2013-04-30 19:00:00','Carpaccio de Bresaola et Jambon de Parme',3); ");
		db.execSQL("INSERT INTO " + TABLE_Order + "(" + Order_column[1] + ", " + Order_column[2] + ", " + Order_column[3] + ", " + Order_column[4] + ", " + Order_column[5] +")  VALUES('Cr�perie Bretonne','j.p@yahoo.fr','2013-05-02 20:00:00','Cr�pe La tartiflette',40); ");
		db.execSQL("INSERT INTO " + TABLE_Order + "(" + Order_column[1] + ", " + Order_column[2] + ", " + Order_column[3] + ", " + Order_column[4] + ", " + Order_column[5] +")  VALUES('Cr�perie Bretonne','j.p@yahoo.fr','2013-04-30 20:00:00','Cr�pe au saumon fum�, sauce cr�me et citron � l''aneth',5); ");
		...
		db.execSQL("INSERT INTO " + TABLE_FavouriteRestaurant + "(" + FavouriteRestaurant_column[1] + ", " + FavouriteRestaurant_column[2] + ")  VALUES('toni@hotmail.com','Cr�perie Bretonne'); ");
		db.execSQL("INSERT INTO " + TABLE_FavouriteRestaurant + "(" + FavouriteRestaurant_column[1] + ", " + FavouriteRestaurant_column[2] + ")  VALUES('j.p@yahoo.fr','Cr�perie Bretonne'); ");
		...
		db.execSQL("INSERT INTO " + TABLE_Specificity + "(" + Specificity_column[1] + ", " + Specificity_column[2] + ") VALUES('j.p@yahoo.fr','V�g�tarien');  ");
		db.execSQL("INSERT INTO " + TABLE_Specificity + "(" + Specificity_column[1] + ", " + Specificity_column[2] + ")  VALUES('toni@hotmail.com','V�g�tarien'); ");
		
		db.execSQL("INSERT INTO " + TABLE_Allergy + "(" + Allergy_column[1] + ", " + Allergy_column[2] + ")  VALUES('toni@hotmail.com','gluten'); ");
		
		db.execSQL("INSERT INTO " + TABLE_MealSpecificity + "(" + MealSpecificity_column[1] + ", " + MealSpecificity_column[2] + ", " + MealSpecificity_column[3] + ") VALUES('Salade Tomates Mozzarella','Cr�perie Bretonne','V�g�tarien');  ");
